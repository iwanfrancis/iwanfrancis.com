...
Define the project's formatting and linting toolchain: a single tool (Biome) that
covers both, with rules preserved from the prior Prettier + ESLint setup, wired into
the package scripts, the pre-commit hook, and the editor.
