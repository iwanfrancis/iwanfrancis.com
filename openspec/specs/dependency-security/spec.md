...
Define the security and consistency guarantees the project's dependency tree and
toolchain MUST uphold, and the build/lint gate that MUST pass before deployment.
